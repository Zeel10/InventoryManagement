    ...
    <div class="container-fluid">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="assignItems.jsp">Assign</a>
                <a href="returnItem.jsp">Return</a>
            </div>
        </div>
        <div class="dropdown">
            <button class="dropbtn">Items</button>
            <div class="dropdown-content">
                <a href="Add_new_items.jsp">Add New Item</a>
                <a href="removeItem.jsp">Remove</a>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="User_list.jsp">User Details</a>
                <a href="Request_status.jsp">Remove</a>
            </div>
        </div>
