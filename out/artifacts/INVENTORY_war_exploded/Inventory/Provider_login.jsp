...
<body>
    ...
    <div class="navbar-header"><a class="navbar-brand navbar-link" href="index.jsp">Inventory Management</a>
                <button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
            </div>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li role="presentation"><a href="../Admin/Admin_login_redirect.jsp">Admin Login</a></li>
                    <li class="active" role="presentation"><a href="#">Provider Login</a></li>
                    <li role="presentation"><a href="User_login_redirect.jsp">User Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="login-card"><img src="../img/avatar_2x.png" class="profile-img-card">
        <p class="profile-name-card">Provider </p>
        <form class="form-signin" action="Provider_login_authenticate.jsp"><span class="reauth-email"> </span>
