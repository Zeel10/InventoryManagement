...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li role="presentation" class="active"><a href=#>Admin Login</a></li>
                    <li role="presentation"><a href="../Inventory/Provider_login_redirect.jsp">Provider Login</a></li>
                    <li role="presentation" ><a href="../Inventory/User_login_redirect.jsp">User Login</a></li>
                </ul>
            </div>
        </div>
    </nav> 
    <div class="login-card"><img src="../img/avatar_2x.png" class="profile-img-card">
        ...
        <form class="form-signin" action="Admin_login_authenticate.jsp"><span class="reauth-email"> </span>
